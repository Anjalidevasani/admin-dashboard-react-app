...
export function Dashboard() {
  return (
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
      <Card title="Cohort Size" value="2000" icon={Users} change="+50.1%" color="bg-purple-500" />
      <Card title="New Comers" value="+30" icon={UserPlus} change="+12.5%" color="bg-green-500" />
      <Card title="Active Users" value="3" icon={ShieldCheck} change="+2" color="bg-pink-500" />
